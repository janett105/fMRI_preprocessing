...
rsimg = nib.load(f'../UCLA_CNP/subject/derivatives/sub-{subjnum}/func/sub-{subjnum}_task-rest_space-MNI152NLin2009cAsym_desc-preproc_bold.nii.gz')

# maskimg -> rsimg에 해당하는 brain mask 경로 입력
maskimg = nib.load(f'../UCLA_CNP/subject/derivatives/sub-{subjnum}/func/sub-{subjnum}_task-rest_space-MNI152NLin2009cAsym_desc-brain_mask.nii.gz')
